...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE usuario set nombre = '$nombre ', apellido_paterno = '$apellido_paterno', apellido_materno = '$apellido_materno', usuario = '$correo', clave = '$clave', tipo_usuario = '$tipo_usuario'
                  WHERE id_usuario=$id";
    ...
    <div class="col-md-4 mx-auto">
      ...
      <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <input type="text" name="correo" class="form-control" placeholder="Usuario" autofocus value="<?php echo $correo; ?>">
          </div>
          <div class="form-group">
